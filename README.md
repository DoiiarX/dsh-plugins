...
| 重启遗言 | `@local/dsh-handoff-plugin` | 重启 handoff（handoff_save/clear/at_restart 三工具 + 重启后自动恢复提醒），harness 生态 TypeScript 插件 | [dsh-handoff-plugin](https://github.com/DoiiarX/dsh-handoff-plugin) | ✅ 已开源 |
...
| OpenAPI 工具 | `@local/dsh-openapi-plugin` | 桥接 OpenAI tools/functions 与 OpenAPI 3.x 格式，注册为可搜索、可调用的函数 | [dsh-openapi-plugin](https://github.com/DoiiarX/dsh-openapi-plugin) | ✅ 已开源 |
